...
import com.example.save_template_backend.service.PromotionHmService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.*;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/api/promotion-hm")
@CrossOrigin(origins = "http://localhost:3000")
public class PromotionHmController {

    @Autowired
    private PromotionHmService service;
